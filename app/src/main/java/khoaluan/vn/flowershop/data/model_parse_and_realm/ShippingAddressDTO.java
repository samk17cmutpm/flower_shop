 ...
 */
public class ShippingAddressDTO extends RealmObject implements Parcelable {
    @SerializedName("Id")
    private String Id;
    ...
    protected ShippingAddressDTO(Parcel in) {
    ...
    public static final Parcelable.Creator<ShippingAddressDTO> CREATOR = new Parcelable.Creator<ShippingAddressDTO>() {
        @Override
        public ShippingAddressDTO createFromParcel(Parcel source) {
            return new ShippingAddressDTO(source);
        }

        @Override
        public ShippingAddressDTO[] newArray(int size) {
            return new ShippingAddressDTO[size];
        }
    };
}
